 ...
 * {@code /internal/node/*}. Bound from {@code opnl.agent.*}. Values are validated at runtime by the
 * agent profile service so the properties stay optional in other profiles.
 */
