...
/**
 * Auto-seeds the demo dataset on first boot when {@code PASSAGE_DEMO_MODE=true}. Runs once after
 * the setup wizard is complete; a {@code demo.seeded} marker keeps later restarts no-ops unless the
